...
#modname "Lands of the Independents: Amogus mode (v0.02)"
#description "LotI with addon that makes indep nations be named as idnies. So you can enjoy chaos of misunderstanding what is going on, who is who and literally play amogus.
You should activate classic LotI or this one at the same time. Activate vanilla nations remover for pure LotI game.
======
...
#brief "Amogus addon breaks brief and summary"
...
#summary "Summary doesnt work with amogus addon. See unmodified LotI for briefs and summaries."
